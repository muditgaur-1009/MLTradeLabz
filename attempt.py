...
month_1 = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=TSLA&interval=1min&slice=year1month1&apikey=RVN9HUMVLT7X9QKR&datatype=csv'
month_2 = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=TSLA&interval=1min&slice=year1month2&apikey=RVN9HUMVLT7X9QKR&datatype=csv'
month_3 = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=TSLA&interval=1min&slice=year1month3&apikey=RVN9HUMVLT7X9QKR&datatype=csv'
month_4=f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=TSLA&interval=1min&slice=year1month4&apikey=RVN9HUMVLT7X9QKR&datatype=csv'
